...
object Utils {
  ...
  val bootstrapServers: String = PropertiesLoader.loadConf("kafka.bootstrap.servers").toString
  ...
  val groupid: String = PropertiesLoader.loadConf("kafka.group.id").toString
}
